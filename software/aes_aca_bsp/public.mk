...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../config.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../qsys_top.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x222e0
SOPC_SYSID_FLAG += --sidp=0x222e0
ELF_PATCH_FLAG  += --sidp 0x222e0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1495498896
SOPC_SYSID_FLAG += --timestamp=1495498896
ELF_PATCH_FLAG  += --timestamp 1495498896
